	...
	public UpdateProviderScreen2(final int pnum) {
		...
		name.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (e.getSource() == name) {
					dispose();
					new UpdateMemberScreen3(pnum, 1);
		...
		address.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (e.getSource() == address) {
					dispose();
					new UpdateMemberScreen3(pnum, 2);
		...
		city.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (e.getSource() == city) {
					dispose();
					new UpdateMemberScreen3(pnum, 3);
		...
		state.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (e.getSource() == state) {
					dispose();
					new UpdateMemberScreen3(pnum, 4);
		...
		zip.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (e.getSource() == zip) {
					dispose();
					new UpdateMemberScreen3(pnum, 5);
